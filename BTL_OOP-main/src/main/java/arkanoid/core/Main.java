...
public class Main extends Application {
        ...
        gameLoop = new AnimationTimer() {
            ...
            public void handle(long now) {
                if ("GAME".equals(currentScreen)) {
                    ...
                    } else if (Constant.STATE_GAME_OVER.equals(gm.getState())) {
                        if (HighScoreManager.isHighScore(gm.getScore())) {
                            showPlayerNameInputScreen();
                        } else {
                            showGameOverScreen();
                        }
                    } else if (Constant.STATE_VICTORY.equals(gm.getState())) {
                        showPlayerNameInputScreen();
                    }
                }
            }
    ...
    private void initScreens() {
        ...
        modeSelectionScreen.setOnHardModeSelected(() -> startGame(GameMode.HARD));
    ...
    private void showPlayerNameInputScreen() {
        ...
        playerNameInputScreen.setOnSubmit(() -> {
            ...
            if (Constant.STATE_GAME_OVER.equals(gm.getState())) {
                showGameOverScreen();
            } else {
                returnToMenu();
            }
