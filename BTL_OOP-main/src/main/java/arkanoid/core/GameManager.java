...
public class GameManager {
    ...
    private final String[] HARD_LEVELS = {"level4.txt", "level5.txt", "level6.txt", "level7.txt"};
    ...
    public void start(GameMode mode) {
        ...
        String[] levelsToUse = (mode == GameMode.HARD) ? HARD_LEVELS : LEVELS;
    ...
    /**
     * increase ball speed in hard mode for x1.3
      */
    private void tuneBall(Ball ball) {
        if (gameMode == GameMode.HARD) {
            ball.setSpeed(Constant.BALL_SPEED * 1.3);
        }
    }
