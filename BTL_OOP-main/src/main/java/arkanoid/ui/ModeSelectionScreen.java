...
public class ModeSelectionScreen extends VBox {
    ...
    private Runnable onHardModeSelected;
    ...
    private void setupUI() {
        ...
        this.setStyle("-fx-background-image: url('/images/background_2.png'); -fx-background-position: center; -fx-background-repeat: no-repeat; -fx-background-size: cover;");
        // Banner
        ...
        hardModeButton = createMenuOption("HARD MODE");
        ...
        hardModeButton.setOnAction(e -> {
            SoundManager.playSound("clickingg.wav");
            if (onHardModeSelected != null) onHardModeSelected.run();
        });
        ...
        buttonBox.getChildren().addAll(normalModeButton, hardModeButton, backButton);
    ...
    public void setOnHardModeSelected(Runnable action) {
        this.onHardModeSelected = action;
    }
