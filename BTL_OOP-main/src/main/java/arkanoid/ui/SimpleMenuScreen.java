...
public class SimpleMenuScreen extends VBox {
    ...
    private VBox createMenuSection() {
        ...
        startButton = createMenuOption("PLAY", true);
    ...
    private VBox createFooterSection() {
        ...
        Text developer = createRetroText("ARKANOID STUDIO", Color.ORANGE, 14, true);


        Text copyright = createRetroText("© 36 STUDIO", Color.WHITE, 12, false);
